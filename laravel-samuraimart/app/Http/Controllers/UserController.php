...
class UserController extends Controller
{
    ...
    public function cart_history_show(Request $request)
    {
        ...
        /* 過去購入したカート情報をLaravelShoppingcartライブラリ経由で取り出すため、以下のrestoreメソッド呼び、$cart_contentsにカート情報を格納しています。
        ただし、restoreメソッドを呼び出すとshoppingcartテーブルからデータが消えてしまう仕様のため、以下のようにstoreメソッドでデータを書き戻す処理が必要になります。
        */
        ...
        /*また、storeメソッドで書き戻した際に、codeカラムやnumberカラムなどの一部データの復元ができない制約があるため、
        以下のupdateメソッドによりデータの書き戻しを行っています*/
