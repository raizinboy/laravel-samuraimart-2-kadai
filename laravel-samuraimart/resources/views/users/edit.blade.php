            ...
            <form method="POST" action="{{ route('mypage') }}">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="name" class="text-md-left samurai-edit-user-info-label">氏名</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show editUserPhone">
                        <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $user->address }}" required autocomplete="address" autofocus placeholder="東京都渋谷区道玄坂ｘ－ｘ－ｘ">
                        @error('address')
                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="text-center">一度退会するとデータはすべて削除され復旧は出来ません</p>
                                </div>
